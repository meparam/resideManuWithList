...
import vp.mom.R;
import vp.mom.adapters.FollowerAdapter;
...
//        back.setClickable(true);
        ...
        tool_title.setText("Following People");
        ...
        session=new SessionManager(vp.mom.activitys.FollowerListActivity.this);
        mListView = (SwipeMenuListView) findViewById(R.id.Followerlistview);


        mAdapter = new FollowerAdapter(this,bookMArkList);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent msg=new Intent(vp.mom.activitys.FollowerListActivity.this, UserProfileDetailActivity.class);
        ...
        SwipeMenuCreator creator = new SwipeMenuCreator() {
            ...
            public void create(SwipeMenu menu) {
                ...
                SwipeMenuItem openItem = new SwipeMenuItem(
                        vp.mom.activitys.FollowerListActivity.this);
                // set item background
    ...
    private void getData() {
     ...
     //   pDialog.setMessage("Loading ...");
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.GET_FOLLOWER, new Response.Listener<String>() {
            @Override
        ...
        try {
            ...
            if(response.getBoolean("status")) {
                ...
                for (int i = 0; i < feedArray.length(); i++) {
                    ...
                    feedItem.setUserId(feedObj.getString("from_user"));
