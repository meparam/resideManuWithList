...
public class QuickReturnRecyclerViewOnScrollListener extends RecyclerView.OnScrollListener {
    ...
    private final vp.mom.quickreturn.QuickReturnViewType mQuickReturnViewType;
...
//                    }
    ...
    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
        ...
        int scrollY = vp.mom.quickreturn.QuickReturnUtils.getScrollY(recyclerView, mColumnCount);
...
//                    break;
    ...
    public static class Builder {
        ...
        public Builder(vp.mom.quickreturn.QuickReturnViewType quickReturnViewType) {
        ...
        public vp.mom.quickreturn.QuickReturnRecyclerViewOnScrollListener build() {
            return new vp.mom.quickreturn.QuickReturnRecyclerViewOnScrollListener(this);
        }
    }
