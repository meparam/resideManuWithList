...
public class ReportPurchasedItem extends Fragment {
    private GridView mGridView;
    private vp.mom.adapters.PurchaseReportAdapter mAdapter;
    ArrayList<SalePurchaseItemPojo> soldItemarray;
    private vp.mom.api.SessionManager session;
    View rootView;
    public ReportPurchasedItem() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new vp.mom.adapters.PurchaseReportAdapter(getActivity(),soldItemarray);
            ...
            if( response.getBoolean("status")) {
                ...
                for (int i = 0; i < feedArray.length(); i++) {
                    ...
                    if (!feedObj.isNull("product_image")) {
                        ...
                        feeditem.setPurchaseDate(feedObj.getString("order_date"));
