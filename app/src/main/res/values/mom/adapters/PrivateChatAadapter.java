 ...
 */
public class PrivateChatAadapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    ArrayList<vp.mom.data.PrivateChatPojo> commentData;

    public PrivateChatAadapter(Context context,ArrayList<vp.mom.data.PrivateChatPojo> mcommentData) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        final vp.mom.data.PrivateChatPojo commentItem=commentData.get(position);

        holder.tvComment.setText(commentItem.getChatMessage());


        Picasso.with(context)
                .load(commentItem.getChatMessage())
...
//                AppConfig.REMOVE_COMMENT_BY_ID, new Response.Listener<String>() {
//
//            @Override
