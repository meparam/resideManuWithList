...
import vp.mom.R;
import vp.mom.searchtab.ItemSerachResult;

/**
 * Created by shivkanya.i on 21-01-2016.
 */
public class SearchItemHintList extends BaseAdapter {
  ArrayList<String> arrayhint;
    Context context;
    private LayoutInflater inflater;
    public   SearchItemHintList(Context mcontaxt, ArrayList<String> marrayhint)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        serchmainll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent msg = new Intent(context, ItemSerachResult.class);
